...
**Offen:** WKO-Termin 7.8. (Wortlaut + Verwechslungsfrage bestätigen; Juristisches eher übers WKO-Rechtsservice) · Alex das Angebot machen — nach seinem Ja: Betrieb Caesar anlegen (Fragebogen + Übergabe-Checkliste), Chat auf die Hausordnung, Zahlungslink schicken · `montageundmehr.at` liegt im Warenkorb, gekauft wird nach der Gewerbeschein-Klärung · Demo zeigt nur Demo-Daten · Mailvorlagen auf die Betriebsfarben · Logo in den PDF-Kopf (`logo_url`) · die übrigen vier Chats auf die Hausordnung umhängen · Handy-Durchgang über alle Seiten · Stripe scharf schalten (nach Kanzlei-Antworten; Erinnerung am 10.8. eingerichtet) · Zeiten-Reiter: Feineinstellung scharf schalten oder ausblenden · Listen-Suche: gebaut, aber Auslieferung hängt am GitHub-Pages-Vorfall — nach dem Durchrutschen mit Alvins Demo-Aufträgen testen. · Preis-Reiter in der App bauen (dieselben Tabellen wie der Chat). · Halbautomatische Preis-Mail bauen (Vorschlag per n8n, Ein-Klick-Bestätigung). · ZZ-Homepage-Chat: Wenn ein Interessent über eine Kundenseite kommt („ich habe euch über Caesar Handmade Guitars entdeckt"), braucht er einen eigenen, warmen Introsatz — er soll sich gehört fühlen statt „aso, nur ein Chat" zu denken; erst danach die Frage „Was ist Ihnen eine Stunde Ihrer Zeit wert?" (Alvins Fund vom 6.8. abends). · ZZ-Homepage: Sobald die Rechtsanwälte-Edition startet, neben „Für kleine Betriebe" eine Auszeichnung „Neu: Für Rechtsanwälte" zeigen.
...
**Am Abend dazugekommen (7.8.):** Die **Tagesübersicht „Heute"** ist der erste Reiter im Legal-Dashboard — Begrüßung nach Uhrzeit, ein Satz mit dem ganzen Tag darin, Termine und Fristen, was Aufmerksamkeit braucht, was in sieben Tagen heranrückt. Dazu ein **Lautsprecher, der den Tag vorliest** (im Browser selbst, nichts wird übertragen; „./." wird als „gegen" gesprochen, BG als Bezirksgericht) mit **wählbarer Stimme**, und ein **Drucker** für die Zettel-Fraktion. Ab 17 Uhr dreht sich die Ansicht zum **Abendbriefing**: statt heute steht morgen im Kasten, und darunter der Satz, um den es geht — *„Nichts davon geht über Nacht verloren."* **Zurückwischen** führt jetzt zurück statt aus der Seite hinaus. Datenbankseitig steht die Grundlage, damit der **Demo-Chat echte Anfragen** schreibt: Spalte `sitzung` und eine eng geführte Funktion, die nur Demo-Zeilen anlegt und eine Anfrage in Ruhe lässt, sobald ein Mensch sie angefasst hat.

**Was wir verkaufen — gefunden am 7.8. abends:** *Wir geben nicht nur Zeit zurück. Wir geben Ruhe zurück.* Dazu Alvins Sätze *„damit Sie abends abschalten können"* und *„Sie gehen nach Hause. Ihre Kanzlei denkt weiter."* Von SOL der Grundsatz *„ZeitZurück ist keine KI-Firma, sondern eine Abläufe-Firma"* und der Identitätssatz *„Menschen bezahlen Fachleute für ihr Können. Sie bezahlen ZeitZurück dafür, dass dieses Können nicht unter der Verwaltung begraben wird."* Eine Korrektur an „wir sind sein Gehirn": Ein Gehirn entscheidet, wir nicht. **Wir sind das Gedächtnis der Kanzlei.** Alle Sätze liegen im Projekt unter „Positionierung in Sätzen".

**Preise recherchiert (7.8.):** JUPUS, der direkte Wettbewerber im Kanzlei-Intake, verlangt 97 € je Nutzer plus 97 € Plattformgebühr monatlich, Einrichtung kostenfrei — eine Dreier-Kanzlei zahlt dort rund 388 €. Daraus folgt: 150 € für eine ganze Kanzlei ist zu billig, 1.500 € Einrichtung sind gegen den Markt. **Entschieden am selben Abend: 249 € im Monat, ganze Kanzlei, alle Nutzer, alles inklusive, keine Nutzerzählerei und keine Zusatzkosten. Einrichtung kostenfrei bei zwölf Monaten Laufzeit. Gründungspreis 199 € für die ersten drei Kanzleien. Der Preis steht offen auf der Seite.** Offen bleibt nur, die tatsächlichen Modellkosten je Kanzlei zu messen — nicht um den Preis zu ändern, sondern um die Marge zu kennen.
...
**Am Abend dazugekommen:** Die Listen-Suche ist gebaut — ein eigener Baustein am Ende von nummernkreis.js, der die fertigen Karten filtert, leere Abschnitte versteckt und „x von y Einträgen" zeigt, mit klebrigem Suchfeld über den Listen. Ausgeliefert ist sie noch nicht: Ein GitHub-Pages-Vorfall blockiert das zeitzurueck-Repo (ein nicht abbrechbarer Zombie-Lauf), ein Wecker prüft alle 45 Minuten; notfalls morgen gemeinsam die Pages-Einstellung neu speichern. Außerdem: Impressum und Datenschutz für Caesar sind live (vier gold markierte offene Angaben = die vier Fragen an Alexander), die Schriften der Caesar-Seite werden jetzt selbst gehostet (Google Fonts raus), und die Visitenkarte ist final — mit der richtigen Nummer +43 676 46 77 626 (die alte Karte hatte eine falsche). Beschlossen: ein Preis-Reiter in der App (schreibt in dieselben Supabase-Tabellen, aus denen der Chat liest — eine Quelle) plus eine halbautomatische Preis-Mail (n8n macht einen Vorschlag, ein Klick bestätigt).

**Als Nächstes:** Morgen (7.8.) der WKO-Termin. Danach das Gespräch mit Alex — das Paket liegt bereit: Muster-Rechnung mit seinem Logo, Einseiter, Zahlungslink. Sagt er ja, folgt der Rest aus Fragebogen und Übergabe-Checkliste: Betrieb Caesar anlegen (Farben, Logo, Wissen — echte Preise erst von ihm), Chat auf die Hausordnung, Link schicken, fertig. Roli (Evolution Ears) danach mit Front Office. An Caesar wird erst nach dem Termin und seinem Ja weitergearbeitet. Danach wartet Alvins **ZeitZurück-für-Rechtsanwälte-Pitch** (Brainstorming mit SOL liegt vor — Alvin glaubt: das wird groß).
...
- **Der Status ist nicht die Auslieferung.** Ein GitHub-Pages-Vorfall färbte alle Läufe rot — bei Caesar war trotzdem längst alles live (nur die Statusmeldung war abgestürzt), beim zeitzurueck-Repo blockierte ein nicht abbrechbarer Zombie-Lauf die Auslieferung wirklich. Zwei verschiedene Wahrheiten hinter identisch roten Kreuzen: Erst der Blick auf die echte Live-Seite zählt, in beide Richtungen.
